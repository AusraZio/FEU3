...
//--------------------------NAMU DARBAI  8 uzduotis-----------------------

{
let pasisveikinimas = true;
let apieMiesta = false;
if(pasisveikinimas === true){
    console.log('Sveiki atvyke į Vilnių!');
    if(apieMiesta === true){
      console.log('Vilnius, žaliausias miestas Europoje');
    } else if(apieMiesta === false){
      console.log('Vilnius turi didžiausia nevalgoma torta eglutę!!');
    } 
} 
}
...
//--------------------------NAMU DARBAI  9 uzduotis-----------------------

let koksMenesis = prompt("Įveskite Mėnesį.");
switch(koksMenesis ){
    case 'Lapkritis':
      console.log("Lapkričio 29");
      break;       
}